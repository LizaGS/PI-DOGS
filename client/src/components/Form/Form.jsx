                    ...
                    <form onSubmit={handleSubmit}>
                        <div className={styled.cont1}>
                            <div className={styled.name}>
                                ...
                                <input type='text' id='name' name='name' value={breed.name} onChange={e => handleChange(e)} />
                                {errors.name && (<h6 className={styled.errors}>{errors.name}</h6>)}<br />
                            </div>

                            <div className={styled.image}>
                                <label htmlFor='image'>Image URL:</label>
                                <input type='url' id='image' name='image' value={breed.image} onChange={e => handleChange(e)} />
                        ...
                        <div className={styled.cont2}>
                            <div className={styled.minheight}>
                                ...
                                <input type='number' id='min_height' name='min_height' value={breed.min_height} onChange={e => handleChange(e)} />
                            ...
                            <div className={styled.maxheight}>
                                ...
                                <input type='number' id='max_height' name='max_height' value={breed.max_height} onChange={e => handleChange(e)} />
                        ...
                        <div className={styled.cont3}>
                            <div className={styled.minweight}>
                                ...
                                <input type='number' id='min_weight' name='min_weight' value={breed.min_weight} onChange={e => handleChange(e)} />
                            ...
                            <div className={styled.maxweight}>
                                ...
                                <input type='number' id='max_weight' name='max_weight' value={breed.max_weight} onChange={e => handleChange(e)} />
                        ...
                        <div className={styled.cont4}>
                            <div className={styled.minlife}>
                                ...
                                <input type='number' id='min_life_span' name='min_life_span' value={breed.min_life_span} onChange={e => handleChange(e)} />
                            ...
                            <div className={styled.maxlife}>
                                ...
                                <input type='number' id='max_life_span' name='max_life_span' value={breed.max_life_span} onChange={e => handleChange(e)} />
